...
function ModalComponent({details}) {
  ...
  return (
    <>
      ...
      <img className="d-block w-100 itemImg" src={details.img[0]}
          alt="Third slide"/>
      </Button>
   ...
   {/* <!--/.Indicators--> */}
    ...
    <div className="carousel-inner" role="listbox">
      ...
      <div className="carousel-item active">
        <img className="d-block w-100 itemImgCarousel" src={details.img[0]}
          alt="First slide"/>
      </div>
      {/* <!--/First slide-->  */}
       {/* <!--Second slide-->  */}
      <div className="carousel-item">
        <img className="d-block w-100 itemImgCarousel" src={details.img[1]}
          alt="Second slide"/>
      </div>
       {/* <!--/Second slide--> */}
      {/* <!--Third slide-->  */}
      <div className="carousel-item">
        <img className="d-block w-100 itemImgCarousel" src={details.img[2]}
          alt="Third slide"/>
      </div>
       {/* <!--/Third slide-->  */}
    </div>
